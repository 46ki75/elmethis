...
/**
 * The Notion block catalog stands on top of the basic catalog. Use it
 * directly (`notionBlockCatalog`) when you want both the basic primitives
 * and the typography block components.
 */
