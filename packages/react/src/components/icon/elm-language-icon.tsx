...
// Storybook radio control). This leaf icon has no meaningful Fast Refresh
// boundary, and qwik keeps the list co-located in the same module.
...
const renderMap: Record<Language, ComponentType<CommonLanguageProps>> = {
  rust: Rust,
