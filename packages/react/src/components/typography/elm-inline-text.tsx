...
export const ElmInlineText = ({
  ...
  if (ruby) {
    vnode = (
      <ruby className={styles["elm-inline-text"]}>
        <span>{vnode}</span>
        <rt>{ruby}</rt>
      </ruby>
    );
  ...
  return (
    <span
      className={clsx(styles["elm-inline-text"], textStyles.text, className)}
      style={
        {
          ...style,
