    ...
    <div style={boxStyle}>
      ...
      <label style={{ display: "block", marginBottom: "0.25rem" }}>
        ...
        <input
          ...
          placeholder="First"
          onInput={(e) =>
            setStore((s) => ({ ...s, first: e.currentTarget.value }))
          }
        />
      </label>
      <label style={{ display: "block", marginBottom: "0.25rem" }}>
        ...
        <input
          ...
          placeholder="Last"
          onInput={(e) =>
            setStore((s) => ({ ...s, last: e.currentTarget.value }))
          }
        />
      </label>
      <label style={{ display: "block", marginBottom: "0.5rem" }}>
        ...
        <input
          ...
          placeholder="Email"
          onInput={(e) =>
            setStore((s) => ({ ...s, email: e.currentTarget.value }))
          }
        />
      </label>
      <p>
 ...
 * `debouncedStore`. Shows that the timer resets on every write.
 */
const CounterDemo = () => {
  const { store, setStore, debouncedStore } = useDebouncedStore(
    { count: 0 },
  ...
  return (
    <div style={boxStyle}>
      ...
      <div style={rowStyle}>
        <button onClick={() => setStore((s) => ({ count: s.count + 1 }))}>
          +1
        </button>
