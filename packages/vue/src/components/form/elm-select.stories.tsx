...
const OPTIONS: ElmSelectOption[] = [
  { id: "minimax/minimax-m2.5", label: "MiniMax: MiniMax M2.5", icon: MiniMax },
  { id: "minimax/minimax-m2.7", label: "MiniMax: MiniMax M2.7", icon: MiniMax },
  { id: "openai/gpt-5.4-nano", label: "OpenAI: GPT-5.4 Nano", icon: OpenAI },
  { id: "openai/gpt-5.4-mini", label: "OpenAI: GPT-5.4 Mini", icon: OpenAI },
  {
...
export const WithIcon: Story = {
  ...
  render: (args) => ({
    components: { ElmSelect, ElmMdiIcon },
    setup() {
      return { args, mdiAccountOutline };
    },
    template: `
...
export const Controlled: Story = {
  render: (args) => ({
    ...
    setup() {
      ...
      return { args, selectedOptionId };
    },
    template: `
      <div style="display: flex; flex-direction: column; gap: 1rem">
        <ElmSelect v-bind="args" label="Controlled select" v-model:selected-option-id="selectedOptionId" />
