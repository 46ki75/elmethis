...
export interface ElmToggleThemeProps extends Omit<HTMLAttributes, "onClick"> {
  /**
...
export const ElmToggleTheme = defineComponent({
  name: "ElmToggleTheme",
  props: {
    size: {
  ...
  setup(props) {
    ...
    // inheritAttrs default: passthrough class/style merge onto the root svg.
    return () =>
      !isDarkTheme.value ? (
        <svg
          ...
          height={props.size}
          viewBox="0 0 24 24"
          class={clsx(styles["elm-toggle-theme"])}
          onClick={toggleTheme}
        >
          <g
            fill="none"
