...
export const Primary: Story = {
  render: (args) => ({
    components: { ElmBlockImage },
    setup() {
      return { args };
    },
    template: `
      <div>
        <ElmBlockImage v-bind="args" />
...
export const LongAlt: Story = {
  args: {
    ...
    caption:
      "One-command deployments and zero-configuration options make it easy to get your Nuxt app live. Choose your platform, and let Nuxt handle the rest.",
  },
};
